  ...
  return `
    <section class="newsletter" id="subscribe">
      <div class="newsletter-copy">
        ...
        <h2>Get the latest take and TV schedule in your inbox.</h2>
      </div>
      <form class="newsletter-form" action="https://app.kit.com/forms/9877935/subscriptions" method="post" data-sv-form="9877935" data-uid="e27a3b8d57" data-format="inline" data-version="5">
        <ul class="formkit-alert formkit-alert-error" data-element="errors" data-group="alert" style="display:none;list-style:none;padding:0;margin:0 0 10px;color:#fff;font-size:13px"></ul>
        <label class="sr-only" for="kit-email">Email address</label>
        <input id="kit-email" class="formkit-input" name="email_address" type="email" placeholder="Enter your email" required>
